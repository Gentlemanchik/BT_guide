...
>***Замечание:** можно поставить одного ОТ ловить [удары ненависти](https://ru.tbc.wowhead.com/spell=28308), можно двух, трёх. Если скилл работает так, как надо (вне зависимости от позиции ОТ в тритлисте), то ОТ нужно одеться максимально жирно, чтобы не оставаться с 6000 здоровья после удара (иначе следующий [удар ненависти](https://ru.tbc.wowhead.com/spell=28308) может прилететь в МДД с бОльшим количеством ХП. Если есть несколько ОТ, то есть подстраховка в виде остальных танков, пока докастуются хилки в словившего [удар ненависти](https://ru.tbc.wowhead.com/spell=28308))*
